\documentclass[tikz,convert={outfile=images/foldNatFree-mmorph-join.svg,density=1000}]{standalone}
\usepackage[build={latexoptions={-output-directory=latex/svg}}]{standalone}
\begin{document}
\tikzstyle{every node}=[color=white!30!black,font=\footnotesize]
